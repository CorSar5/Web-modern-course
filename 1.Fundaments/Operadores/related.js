...
console.log('02)', '1' === 1) // false, restritamente 1 é string o outro number
console.log('03)', '3' != 3) // false
console.log('04)', '3' !==3) // true, restritamente 1 é string o outro number
...
// '===' ou estritamente igual é o mais recomendável para os tipos não serem ignorados