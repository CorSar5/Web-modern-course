<template>
  <div class="auth-content">
      ...
      <input v-if="showSignup" v-model="user.name" placeholder="Name" type="text">
      ...
      <a href @click.prevent="showSignup = !showSignup">
          <span v-if="showSignup">Are you registered? Log In Now!</span>
          <span v-else>Register Yourself Now!</span>
      </a>
      </div>
...
<style>
    ...
    .auth-modal hr {
        ...
        rgba(120, 120, 120, 0),rgba(120, 120, 120, 0.75),
        rgba(120, 120, 120, 0));
    }
</style>